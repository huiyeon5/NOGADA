...
class DataViz3 extends Component {  
    ...
    componentDidMount(){
        this.callBackendAPI('/getcities')
        .then(res => {
            let datas = res.data;
            let countries = []
            datas.forEach(function(d){
                countries.push(d['cities']);
            })
        ...
        var map = this.map = L.map('map', {
            ...
            layers: [
                ...
                maxZoom: 10,
                id: 'mapbox.satellite',
                accessToken: 'pk.eyJ1Ijoia2ltZG95ZW9uMTIzNDUiLCJhIjoiY2pvZ3p3OWVrMGtvbzN2cWQyeTZlOGw4eSJ9.gW9HbIQwkq0E6K-kjJjCOw'
                }),
            ]            
        });
        var geojsondata ={
            ...
            "features": [
                ...
                "properties": {
                    "code": 38,
                    "name": "경상남도",
                    "name_eng": "South Gyeongsang",
                    "base_year": 2018,
                    "Tourist_Visitors": 8377428
                },
                "geometry": {
                    "type": "MultiPolygon",
                    "coordinates": [
                ...
                "properties": {
                    "code": 37,
                    "name": "경상북도",
                    "name_eng": "North Gyeongsang",
                    "base_year": 2018,
                    "Tourist_Visitors":25063423
                },
                "geometry": {
                    "type": "MultiPolygon",
                    "coordinates": [
                ...
                "properties": {
                    "code": 36,
                    "name": "전라남도",
                    "name_eng": "South Jeolla",
                    "base_year": 2018,
                    "Tourist_Visitors":31584914
                ...
                "properties": {
                    "code": 35,
                    "name": "전라북도",
                    "name_eng": "North Jeolla",
                    "base_year": 2018,
                    "Tourist_Visitors":21600128
                },
                "geometry": {
                    "type": "MultiPolygon",
                    "coordinates": [
                ...
                "properties": {
                    "code": 34,
                    "name": "충청남도",
                    "name_eng": "South Chungcheong",
                    "base_year": 2018,
                    "Tourist_Visitors":84972096
                ...
                "properties": {
                    "code": 33,
                    "name": "충청북도",
                    "name_eng": "North Chungcheong",
                    "base_year": 2018,
                    "Tourist_Visitors":14724175
...
legend.addTo(map);
        ...
        function style(feature) {
            return {
                fillColor: getColor(feature.properties.Tourist_Visitors),
                weight: 2,
                opacity: 1,
                color: 'white',
                dashArray: '3',
        ...
        function resetHighlight(e) {
            L.geoJson(geojsondata, {style: style}).resetStyle(e.target);
        }
        ...
        L.geoJson(geojsondata, {
        ...
        }).addTo(map).on('click', async function(e) {
            ...
            const response = await fetch('/getno_of_visitors_onT', {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
                  },
                body:JSON.stringify({city:e.propagatedFrom.feature.properties.name_eng})
            })
            ...
            const response2 = await fetch('/getno_of_visitors_onTY', {
                ...
                body:JSON.stringify({city:e.propagatedFrom.feature.properties.name_eng,Year:this.state.Year})
            })

            const body2 = await response2.json();

            let datas2 = body2.data;
            ...
            .then(res => {
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    console.log(e);
                    const resp = await fetch('/getAttraction' ,{
                        method: 'POST',
                        headers: {
                            'Accept': 'application/json',
                            'Content-Type': 'application/json'
                    ...
                    const response = await fetch('/getlocal', {
                        method: 'POST',
                        headers: {
                            'Accept': 'application/json',
                            'Content-Type': 'application/json'
                    ...
                    const response2 = await fetch('/getlocalY', {
                        method: 'POST',
                        headers: {
                            'Accept': 'application/json',
                            'Content-Type': 'application/json'
                            },
                        body:JSON.stringify({Year:self.state.Year})
                    })
                    const body2 = await response2.json();
                    let datas2 = body2.data;
                    let dataList2 = []
                    ...
                    self.setState({ purpose2: dataList ,Clicked:false,purposeY3 :dataList2 ,Clicked2:false, attraction : r.data[0]['tourist_attraction']})
                    })
                }
        ...
        this.postData('/getForeigner_FilterY',{Year:this.state.Year})
        .then(res => {
            let datas = res.data;
        ...
        if( this.state.Clicked === null){
            lines2 = (
                <LineChart width={950} height={250} data={this.state.purpose} className="line">
                    ...
                    <Tooltip />
                    <Legend />
                    {/* <ReferenceLine y= label="Max" stroke="red"/> */}
                    <Brush dataKey='label' height={30} stroke="#8884d8"/>
                    <Line yAxisId="left"  type="monotone" dataKey="Foreigner" stroke="#8884d8" dot ={false}/>
                    <Line yAxisId="right"  type="monotone" dataKey="Local" stroke="#82ca9d" dot= {false}/>
                </LineChart>
            )
            ...
            lines3 = (
                <LineChart width={950} height={250} data={this.state.purpose2} className="line">
                    ...
                    {/* <ReferenceLine y= label="Max" stroke="red"/> */}
                    <Brush dataKey='label' height={30} stroke="#8884d8"/>
                    <Line yAxisId="left" connectNulls={true} type="monotone" dataKey="Foreigner" stroke="#8884d8" dot ={false}/>
                    <Line yAxisId="right" connectNulls={true} type="monotone" dataKey="Local" stroke="#82ca9d" dot= {false}/>
                </LineChart>
            )
        }

        return (  
            <div className="dataviz3_2">
